...
function Navbar() {
  ...
  return (
    <div className='navbar-container'>
      <Link to='/dashboard'>
      <svg id="mySvg" width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg id="mySvg" width="24" height="27" viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg">
